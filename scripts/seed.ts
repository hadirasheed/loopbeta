/**
 * Seed script: inserts demo restaurants + ~36 dishes so the app is runnable
 * without manual data entry. The admin dashboard is the real way to manage
 * the catalog; this is demo data only.
 *
 * Usage:
 ...
 * (loaded from .env.local via the npm script).
 */
